...
<?php if ( have_comments() ) : ?>
	<div id="comments">
		<div class="total-comments"><span><?php comments_number(__('Sin comentarios','landing-pageasy'), __('Comentarios','landing-pageasy'),  __('% Comentarios','landing-pageasy') );?></span></div>
	...
	<div id="commentsAdd">
		<div id="respond" class="box m-t-6">
			<?php global $aria_req; $comments_args = array(
				'title_reply'=>'<h4><span>'.__('Añadir un comentario','landing-pageasy').'</span></h4></h4>',
