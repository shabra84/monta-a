  ...
  <div class="wrap about-wrap landing-pageasy-add-css">
    <div>
      ...
      <div class="feature-section three-col">
        ...
        <div class="col">
          <div class="widgets-holder-wrap">
            <h3><?php echo __("View our other themes", "landing-pageasy"); ?></h3>
            <p><?php echo __("Do you like our concept but feel like the design doesn't fit your need? Then check out our website for more designs.", "landing-pageasy"); ?></p>
            <p><a target="blank" href="<?php echo esc_url('https://superbthemes.com/wordpress-themes/', 'landing-pageasy'); ?>" class="button button-primary">
              <?php echo __("View All Themes", "landing-pageasy"); ?>
            </a></p>
          </div>
        </div>
        <div class="col">
